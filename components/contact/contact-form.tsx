...
export function ContactForm() {
  ...
  return (
    <>
      {/* Confetti canvas — always mounted so the ref is available */}
      <Confetti
        ref={confettiRef}
        manualstart
        aria-hidden="true"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6" noValidate>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              className="resize-none rounded-lg border border-input bg-transparent px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring"
